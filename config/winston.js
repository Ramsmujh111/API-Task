...
const logger = winston.createLogger({
  ...
  transports: [
    ...
    new winston.transports.File({ filename: `logs_/error_${date.getFullYear()+'-'+date.getDate()+'-'+date.getDay()}.log`, level: "error" }),
    new winston.transports.File({ filename: `logs_/info_${date.getFullYear()+'-'+date.getDate()+'-'+date.getDay()}.log` }),
  ],
});
